  ...
  return (
    <div className="glassmorphism grid md:grid-cols-5 gap-4">
      <div className="md:col-span-4">
        ...
        <h3 className="font-semibold text-gray-500 text-2xl mt-2">¡Ofrecé tus clases en nuestro Marketplace!</h3>
        ...
        <button className="outline_btn mt-6 uppercase font-bold">
          Registrate ahora
        </button>
      </div>
